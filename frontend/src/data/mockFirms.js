export const MOCK_FIRMS = [
  {
    ...
    categories: [
      ...
      { id: "online", name: "Online Presence", score: 94, detail: "Strong and consistent mock web footprint with no suspicious activity." }
    ]
  },
  {
    id: "globex",
    ...
    categories: [
      ...
      { id: "online", name: "Online Presence", score: 30, detail: "Thin mock web footprint and a few negative mentions." }
    ]
  },
  {
    id: "umbrella",
    ...
    categories: [
      ...
      { id: "online", name: "Online Presence", score: 12, detail: "Very little verifiable mock web presence; several bad mentions." }
    ]
  },
  {
    id: "stark",
    ...
    categories: [
      ...
      { id: "online", name: "Online Presence", score: 80, detail: "Good mock web footprint with mostly positive coverage." }
    ]
  },
  {
    id: "wayne",
    ...
    categories: [
      ...
      { id: "online", name: "Online Presence", score: 88, detail: "Well-established mock web presence with positive mentions." }
    ]
  },
  {
    id: "inosh",
    ...
    categories: [
      ...
      { id: "online", name: "Online Presence", score: 51, detail: "Limited mock web presence; not enough data to judge clearly." }
    ]
  },
  {
    id: "northwind",
    ...
    categories: [
      ...
      { id: "online", name: "Online Presence", score: 66, detail: "Decent mock web footprint with a few unresolved mentions." }
    ]
  }
];
